...
namespace Casgem_RealEstateProject_Consume.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class EstateController : Controller
    {
        ...
        public async Task<IActionResult> AddEstate(Estate estate)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:44332/api/Estate/Insert", httpContent);
        ...
        public async Task<IActionResult> UpdateEstate(Estate estate)
        {
            ...
            var responseMessage = await client.PutAsync($"https://localhost:44332/api/Estate/Update?id={estate.Id}", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"https://localhost:44332/api/Estate/Delete?id={id}");
